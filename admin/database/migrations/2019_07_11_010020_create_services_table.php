...
class CreateServicesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableName, function (Blueprint $table) {
            ...
            $table->string('serial_doc', 5)->nullable()->comment('Serie del servicio.');
            $table->integer('number_doc')->nullable()->comment('Número del servicio.');
            ...
            $table->date('date_aproved')->nullable()->comment('Fecha de aprovación del servicio por la empresa.');
            $table->date('date_aproved_customer')->nullable()->comment('Fecha de aprovación del servicio por parte del liente..');
            $table->text('description')->nullable()->comment('Descripción general de la solicitud de servicio.');
