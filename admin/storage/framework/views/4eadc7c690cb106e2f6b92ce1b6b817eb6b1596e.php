        ...
        <div class="card-group mb-0">
            <div class="card p-4">
                <form class="form-horizontal was-validated" method="POST" action="<?php echo e(route('login')); ?>" >
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3 <?php echo e($errors->has('email' ? 'is-invalid' : '')); ?>">
                            <span class="input-group-addon"><i class="icon-user"></i></span>
                            <input type="email" name="email" id="email" class="form-control" placeholder="Correo" value="<?php echo e(old('email')); ?>">
                            <?php echo $errors->first('email', '<span class="invalid-feedback">:message</span>'); ?>

                        </div>
                        <div class="input-group mb-4 <?php echo e($errors->has('password' ? 'is-invalid' : '')); ?>">
            ...
            <div class="card text-white bg-primary py-5 d-md-down-none" style="width:44%">
                <div class="card-body text-center">
                    <div>
                        <h2><?php echo e(env('NAME_COMMERCIAL_PROJECT')); ?></h2>
