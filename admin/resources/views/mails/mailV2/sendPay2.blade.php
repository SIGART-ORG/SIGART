                                                ...
                                                <tr>
                                                    <td style="text-align:justify; color: #6f6f6f; ">
                                                        <div style="max-width: 100%; margin: 20px auto 5px auto">
                                                            ...
                                                            Nos es grato dirigirnos a usted a fin de comunicarle que el
                                                            servició <strong>{{ $code }}</strong> se culminó de manera satisfactoría.
                                                            También para indicarle que el servicio en mención aun cuenta
                                                            con una deuda pendiente, el cual es de
                                                            <strong>S/. {{ $mount_diff }}</strong>, le solicitamos
                                                            nos pueda hacer llegar una foto del voucher de depósito, y de
                                                            esta manera podamos dar por finalizado el servicio prestado.
                                                        </div>
