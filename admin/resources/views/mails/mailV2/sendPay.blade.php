                                ...
                                <tr>
                                    <td style="background-color:#3bcdb0;">
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%">
                                            <tr>
                                                <td>
                                                    <img src="{{ asset( 'images/background-mail-header.gif') }}" style="max-width:100%; display:block;">
                                                </td>
                                            </tr>
                                        </table>
                                                ...
                                                <tr>
                                                    <td style="text-align:justify; color: #6f6f6f; ">
                                                        <div style="max-width: 100%; margin: 20px auto 5px auto">
                                                            ...
                                                            Nos es grato dirigirnos a usted a fin de comunicarle que está
                                                            pendiente el pago adelantado del <strong>50% de S/. {{ $mount_total }}</strong> como
                                                            mínimo del servicio, le solicitamos nos pueda hacer llegar una
                                                            foto del voucher de depósito, y de esta manera podamos dar
                                                            inicio al servicio requerido a la empresa en la fecha pactada.
                                                            <br/><br/>
                                                            El adelanto mínimo es de <strong>S/. {{ $mount_min }}</strong>,
                                                            que viene a ser el 50% del total del servicio.
                                                        </div>
