                                                ...
                                                <tr>
                                                    <td style="text-align:justify; color: #6f6f6f; ">
                                                        <div style="max-width: 100%; margin: 20px auto 5px auto">
                                                            ...
                                                            día de hoy domingo {{ $date_finish }} se culminó con el servicio
                                                            {{ $code }} de forma satisfactoria, es por ello que se deja
                                                            constancia que se deja constancia de que no existe ningún
                                                            inconveniente por ambas partes.
                                                        </div>
