                                            ...
                                            <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                                                <tr>
                                                    <td style="text-align:left; color: #6f6f6f;">
                                                        <br>
                                                        Estimado {{ $name }},<br><br>
                                                        Nos es grato dirigirnos a usted a fin de comunicarle que el día de hoy
                                                        {{ $date }} la orden de servicio fue generada y aprobada por la
                                                        empresa DPINTART, le solicitamos amablemente, puedan aprobar la
                                                        orden de servicio como clientes para de esta manera seguir con
                                                        el trámite correspondiente para el inicio del servicio.
                                                        <br>
                                                        Se adjunta su orden de servicio, firmarse y adjuntarlo al sistema:<br><br>
                                                ...
                                                <td style="text-align:center; margin:0 auto;">
                                                    ...
                                                    <div><!--[if mso]>
                                                        ...
                                                        <a href="{{ $urlConfirmation }}"
                                                           style="background-color:#f5774e;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:220px;-webkit-text-size-adjust:none;">Visitanos</a>
                                                        <!--[if mso]>
                                                        </center>
                                                        </v:rect>
                                                        <![endif]--></div>
