...
<section class="container">
    <div class="content-detail middle">
        <table>
            ...
            <tr>
                <th>Periodo</th>
                <th colspan="2">{{ $reference->dateSRApproved->year }}</th>
            </tr>
            <tr>
                <th>N°</th>
                <th colspan="2">{{ $reference->srDocument }}-{{ $reference->srDocumentNum }}</th>
            </tr>
            <tr>
                <th>Día</th>
                <th>Mes</th>
            ...
            <tr>
                <th>{{ $reference->dateSRApproved->year }}</th>
                <th>{{ $reference->dateSRApproved->month }}</th>
                <th>{{ $reference->dateSRApproved->day }}</th>
            </tr>
            </thead>
        </table>
    </div>
