                    ...
                    <div class="col-md-3" >
                        <div style="border: 1px solid #CFCFCF; padding: 10px;">
                            ...
                            <div class="list-group">
                                <a href="#" class="list-group-item  list-group-item-action active" @click.prevent="generarListado(service)">Generar Listado</a>
                                <a href="#" class="list-group-item list-group-item-action" @click.prevent="generarCotizacion(service)">Cotizar</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-6">
                                    <div style="border: 1px solid #CFCFCF; padding: 10px;">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li :key="dato.id" class="list-group-item list-group-item-info ">{{dato.name}}</li>
                                            </template>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <form class="form-inline">
                                                    <div class="form-row align-items-left">
                                                        <div class="col-auto">
                                                            ...
                                                            <input type="text" v-model="search" @keyup="listproduc( 1, search, typeProduct )"
                                                        ...
                                                        <div  class="col-auto">
                                                            ...
                                                            <select class="form-control mb-2" id="inlineFormInput2" v-model="typeProduct" @change="listproduc( 1, search, typeProduct )">
                                                        ...
                                                        <div class="col-auto">
                                                            <button type="submit" class="btn btn-primary mb-2" @click="listproduc( 1, search, typeProduct )">
